  ...
  return (
    <div className="bg-gray-800 p-4 text-white">
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div>
          <h2 className="text-2xl font-bold mb-4">Speed View</h2>
          <p className="mb-4">
            "Explore the world with us—your adventure starts here! Let our
            expert team craft unforgettable experiences tailored just for you.
          </p>
        </div>
      ...
      <div className="flex justify-between border-t border-gray-700 pt-4">
        <p>&copy; 2024 Speed View. All rights reserved.</p>
